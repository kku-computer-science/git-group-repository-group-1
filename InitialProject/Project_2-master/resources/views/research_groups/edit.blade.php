...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            <h4 class="card-title">{{ trans('message.researchGroupEdit') }}</h4>
            <p class="card-description">{{ trans('message.researchGroupDetailEdit') }}</p>
            <form action="{{ route('researchGroups.update',$researchGroup->id) }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="form-group row">
                    <p class="col-sm-3"><b>{{ trans('message.projectManager') }}</b></p>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <p class="col-sm-3 pt-4"><b>{{ trans('message.projectMember') }}</b></p>
                    <div class="col-sm-8">
