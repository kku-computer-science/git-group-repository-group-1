...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            <h4 class="card-title">{{ trans('message.titlePatent') }}</h4>
                ...
                <table id ="example1" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('message.nameTitle') }}</th>
                            <th>{{ trans('message.type') }}</th>
                            <th>{{ trans('message.dateOfRegistration') }}</th>
                            <th>{{ trans('message.registrationNumber') }}</th>
                            <th>{{ trans('message.producer') }}</th>
