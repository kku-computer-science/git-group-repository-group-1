        ...
        <div class="carousel-inner">
            <?php $__empty_1 = true; $__currentLoopData = $highlights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $highlight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="carousel-item <?php echo e($index == 0 ? 'active' : ''); ?>">
                    <img src="<?php echo e(asset($highlight->image_url)); ?>" class="d-block w-100" alt="<?php echo e($highlight->title); ?>">
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <!-- Default image if no highlights exist -->
                <div class="carousel-item active">
                    <img src="<?php echo e(asset('img/default_banner.png')); ?>" class="d-block w-100" alt="Default Image">
                </div>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project_2-master\Project_2-master\resources\views/home.blade.php ENDPATH**/ ?>