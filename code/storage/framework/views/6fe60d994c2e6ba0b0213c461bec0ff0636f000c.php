    ...
    <div class="bg-white shadow rounded-lg d-block d-sm-flex">
        <div class="profile-tab-nav border-right">
            <div class="p-4">
                <div class="img-circle text-center mb-3">
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary btn-block btn-sm" id="change_picture_btn"><b><?php echo e(trans('message.changePicture')); ?></b></a>
                </div>
        ...
        <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
            ...
            <div class="tab-pane " id="account" role="tabpanel" aria-labelledby="account-tab">
                <h3 class="mb-4"><?php echo e(trans('message.profileSetting')); ?></h3>
                <form class="form-horizontal" method="POST" action="<?php echo e(route('adminUpdateInfo')); ?>" id="AdminInfoForm">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group col-sm-4">
                                <label><?php echo e(trans('message.nameTitle')); ?></label>
            ...
            <div class="tab-pane fade " id="password" role="tabpanel" aria-labelledby="password-tab">
                <form class="form-horizontal" action="<?php echo e(route('adminChangePassword')); ?>" method="POST" id="changePasswordAdminForm">
                    <h3 class="mb-4"><?php echo e(trans('message.passwordSetting')); ?></h3>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo e(trans('message.oldPassword')); ?></label>
                                <input type="password" class="form-control" id="inputpassword" placeholder="<?php echo e(trans('message.enterCurrentPassword')); ?>" name="oldpassword">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo e(trans('message.newPassword')); ?></label>
                                <input type="password" class="form-control" id="newpassword" placeholder="<?php echo e(trans('message.enterNewPassword')); ?>" name="newpassword">
                                <span class="text-danger error-text newpassword_error"></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo e(trans('message.confirmNewPassword')); ?></label>
                                <input type="password" class="form-control" id="cnewpassword" placeholder="<?php echo e(trans('message.reEnterNewPassword')); ?>" name="cnewpassword">
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git-group-repository-group-1\code\resources\views/dashboards/users/profile.blade.php ENDPATH**/ ?>