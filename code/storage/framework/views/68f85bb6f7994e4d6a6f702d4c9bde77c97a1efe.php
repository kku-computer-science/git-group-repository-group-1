            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text"><?php echo e(trans('message.titleDashboard')); ?><span
...
<li class="nav-item">
                    <div class="language-switcher">
                        <button class="lang-item lang-item-63 lang-item-en current-lang <?php echo e(App::getLocale() == 'en' ? 'active' : ''); ?>" 
                                onclick="window.location.href='<?php echo e(route('langswitch', 'en')); ?>'">
                            EN
                        </button>
                        <button class="lang-item lang-item-44 lang-item-th lang-item-first <?php echo e(App::getLocale() == 'th' ? 'active' : ''); ?>" 
                                onclick="window.location.href='<?php echo e(route('langswitch', 'th')); ?>'">
                            TH
                        </button>
                    </div>
                </li>
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        document.getElementById ('logout-form').submit();"> <?php echo e(trans('message.logout')); ?> <i class="mdi mdi-logout"></i></a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('admin/profile*')) ? 'active' : ''); ?>"
                            ...
                            <span class="menu-title"><?php echo e(trans('message.userProfile')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('funds.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manageFund')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ManagePublications" aria-expanded="false" aria-controls="ManagePublications">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.managePublication')); ?></span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ManagePublications">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('papers.index')); ?>"><?php echo e(trans('message.publishedResearch')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/books"><?php echo e(trans('message.book')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/patents"><?php echo e(trans('message.otherAcademic')); ?></a></li>
                            </ul>
                        </div>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('programs.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manageProgram')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('experts.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(trans('message.manageExpertise')); ?></span>

                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('highlights-list')): ?>
                    <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('highlights.index')); ?>">
                        <i class="menu-icon mdi mdi-star-outline"></i>
                        <span class="menu-title"><?php echo e(trans('message.manageHighlight')); ?></span>
                     </a>
                    </li>
                    <?php endif; ?>
                </ul>
...
</html><?php /**PATH C:\xampp\htdocs\git-group-repository-group-1\code\resources\views/dashboards/users/layouts/user-dash-layout.blade.php ENDPATH**/ ?>